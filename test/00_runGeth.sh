...
geth --dev --dev.period 0 --datadir ./testchain --rpc --rpccorsdomain '*' --rpcport 8646 --rpcapi "eth,net,web3,personal,txpool,debug" --port 32323 --maxpeers 0 --targetgaslimit 994712388 --cache 2048 --verbosity 3 console
